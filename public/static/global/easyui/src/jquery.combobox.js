...
(function($){
	 ...
	 * set values
	 */
	function setValues(target, values, remainText){debugger
		var opts = $.data(target, 'combobox').options;
		var panel = $(target).combo('panel');
	 ...
	 */
	function loadData(target, data, remainText){debugger
		var state = $.data(target, 'combobox');
	 ...
	 */
	function request(target, url, param, remainText){debugger
		var opts = $.data(target, 'combobox').options;
		if (url){
			opts.url = url;
		}
...
//		param = param || {};
	 ...
	 * do the query action
	 */
	function doQuery(target, q){debugger
		var state = $.data(target, 'combobox');
		var opts = state.options;
	...
	function doEnter(target){debugger
		var t = $(target);
	 ...
	 */
	function create(target){debugger
		var state = $.data(target, 'combobox');
		var opts = state.options;
